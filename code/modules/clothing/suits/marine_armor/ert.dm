...
/obj/item/clothing/suit/storage/marine/smartgunner/veteran/pmc/apesuit
	name = "\improper M5Xg apesuit gunner armor"
...
/obj/item/clothing/suit/marine/veteran/pmc
	...
	valid_accessory_slots = list(ACCESSORY_SLOT_MEDAL, ACCESSORY_SLOT_DECORARMOR, ACCESSORY_SLOT_DECORGROIN, ACCESSORY_SLOT_DECORSHIN, ACCESSORY_SLOT_DECORBRACER, ACCESSORY_SLOT_M3UTILITY, ACCESSORY_SLOT_PLATE, ACCESSORY_SLOT_PONCHO, ACCESSORY_SLOT_DECORKNEE, ACCESSORY_SLOT_DECORNECK, ACCESSORY_SLOT_PAINT)
	restricted_accessory_slots = list(ACCESSORY_SLOT_DECORARMOR, ACCESSORY_SLOT_DECORGROIN, ACCESSORY_SLOT_DECORBRACER, ACCESSORY_SLOT_DECORSHIN, ACCESSORY_SLOT_M3UTILITY, ACCESSORY_SLOT_PLATE, ACCESSORY_SLOT_DECORKNEE, ACCESSORY_SLOT_DECORNECK, ACCESSORY_SLOT_PAINT)
...
/obj/item/clothing/suit/marine/veteran/pmc/smartgun //Smartgun Spec Armor
	...
	valid_accessory_slots = list(ACCESSORY_SLOT_MEDAL, ACCESSORY_SLOT_DECORARMOR, ACCESSORY_SLOT_M3UTILITY, ACCESSORY_SLOT_PLATE, ACCESSORY_SLOT_PONCHO, ACCESSORY_SLOT_DECORKNEE, ACCESSORY_SLOT_DECORNECK)
	restricted_accessory_slots = list(ACCESSORY_SLOT_DECORARMOR, ACCESSORY_SLOT_M3UTILITY, ACCESSORY_SLOT_PLATE, ACCESSORY_SLOT_DECORKNEE, ACCESSORY_SLOT_DECORNECK)
...
/obj/item/clothing/suit/marine/veteran/pmc/engineer
	...
	flags_marine_armor = null
	actions_types = null
	valid_accessory_slots = list(ACCESSORY_SLOT_MEDAL, ACCESSORY_SLOT_M3UTILITY, ACCESSORY_SLOT_PLATE, ACCESSORY_SLOT_PONCHO,)
	restricted_accessory_slots = list(, ACCESSORY_SLOT_M3UTILITY, ACCESSORY_SLOT_PLATE,)
