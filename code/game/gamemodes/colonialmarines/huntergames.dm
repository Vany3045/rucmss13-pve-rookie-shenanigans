#define HUNTER_BEST_ITEM  pick(\
								...
								50; list(/obj/item/clothing/under/marine/veteran/pmc/apesuit, /obj/item/clothing/suit/storage/marine/veteran/pmc/apesuit, /obj/item/clothing/gloves/marine/veteran/pmc/apesuit, /obj/item/clothing/shoes/marine/rmc, /obj/item/clothing/head/helmet/marine/veteran/pmc/apesuit), \
...
\
								100; /obj/item/storage/backpack/commando/apesuit, \
...
/datum/game_mode/huntergames/proc/spawn_contestant(mob/M)
	...
	switch(randjob)
		...
		if(10) //Colonial Marshal
			H.equip_to_slot_or_del(new /obj/item/clothing/under/cmb(H), WEAR_BODY)
